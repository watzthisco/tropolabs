...
define("CONSUMER_KEY", "KRvdEp4FC2ejyMWAK84xe4wcf");
define("CONSUMER_SECRET","5XpiQsFLbPfEQpN5daQ3NPuLqt4VJq5n2LdpJDJGNmLpFL3Ndi");
define("OAUTH_TOKEN", "2784218191-dID4JfkEqFdJQxV4uHhuqWTpVz5XPuGwo2JQpmR");
define("OAUTH_SECRET", "1aQ6ycWnS3Pq3ySOZY3VlNrtKWvHHq6hsUMBYQOdetHa7");
$connection = new TwitterOAuth(CONSUMER_KEY, CONSUMER_SECRET, OAUTH_TOKEN, OAUTH_SECRET);
$content = $connection->get('account/verify_credentials');
$connection->post('statuses/update', array('status' => 'test tweeting from tropo')); ?>
